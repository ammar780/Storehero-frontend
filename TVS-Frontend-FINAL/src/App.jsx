...
import { LayoutDashboard, Package, ShoppingCart, Megaphone, Palette, DollarSign, TrendingUp, Users, Target, LineChart, Zap, Calculator, Settings, LogOut, ChevronLeft, ChevronRight, Menu, X } from 'lucide-react';
    ...
    <div className="flex h-screen overflow-hidden bg-surface-50">
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="lg:hidden sticky top-0 z-30 h-14 bg-white/80 backdrop-blur-xl border-b border-surface-100 flex items-center px-4 gap-3">
          ...
          <div className="font-display font-bold text-brand-900 text-sm">TVS Profit</div>
        </div>
