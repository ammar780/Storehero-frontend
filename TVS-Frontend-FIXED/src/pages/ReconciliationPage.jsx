...
export default function ReconciliationPage() {
  ...
  const { data, loading } = useApi('/finance/reconciliation', { period }, [period]);
  const t = data?.totals || {};
      ...
      {loading ? <><SkeletonCards count={4} /><SkeletonTable /></> : (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Elavon */}
            <div className="bg-white dark:bg-surface-800 rounded-2xl border border-surface-100 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div><h3 className="font-display font-bold text-surface-800 dark:text-surface-200">Elavon (Credit Cards)</h3><p className="text-xs text-surface-400">Transfer: {accts.elavon?.transferDays || '1-2 days'}</p></div>
              </div>
            ...
            <div className="bg-white dark:bg-surface-800 rounded-2xl border border-surface-100 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div><h3 className="font-display font-bold text-surface-800 dark:text-surface-200">PayPal</h3><p className="text-xs text-surface-400">Transfer: {accts.paypal?.transferDays || '1-3 days'}</p></div>
              </div>
              <div className="space-y-3">
