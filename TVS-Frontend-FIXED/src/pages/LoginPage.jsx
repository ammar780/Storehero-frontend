...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex dark:bg-surface-900 items-center justify-center bg-gradient-to-br from-sidebar-950 via-sidebar-900 to-sidebar-800 relative overflow-hidden">
